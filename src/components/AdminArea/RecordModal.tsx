...
export const RecordModal: FC<Props> = function ({ type, isOpen, setOpen, record, setRecord, setIsCompleted }) {
    ...
    const validateInput = () => {
        if (type === TYPE.ADD) {
            if (record.staff.firstname && record.staff.lastname && record.staff.email &&
                record.seqNo && record.serialNo && record.formNo && record.uploadFile
                && record.publishedDate && record.whMonthStart && record.whMonthEnd)
                setIsValid(true);
            else setIsValid(false);
        }
        else {
            if (record.seqNo && record.serialNo && record.formNo
                && record.publishedDate && record.whMonthStart && record.whMonthEnd)
                setIsValid(true);
            else setIsValid(false);
        }
    ...
    return (
        <>
            <Modal onClose={() => { setOpen(false); setRecord(initRecord); }} show={isOpen}>
                ...
                <Modal.Body>
                    <div className="grid grid-cols-1 gap-6 sm:grid-cols-2">
                        {type === TYPE.ADD && <><div>
                            <Label htmlFor="firstName">First Name</Label> <span className="red-star"> *</span>
                            <div className="mt-1">
                                <TextInput
                                    id="firstname"
                                    name="firstname"
                            ...
                            <div>
                                <Label htmlFor="lastname">Last Name</Label> <span className="red-star"> *</span>
                                <div className="mt-1">
                                    <TextInput
                                        id="lastname"
                                        name="lastname"
                        ...
                        <div>
                            <Label htmlFor="whMonth">Withholding month</Label> <span className="red-star"> *</span>
                            <div className="mt-1">
                                <DatePicker
                                    selectsRange={true}
                        ...
                        <div>
                            {/* Published date */}
                            <Label htmlFor="publishedDate">Issue date</Label> <span className="red-star"> *</span>
                            <div className="mt-1">
                                <DatePicker
                                    selected={record.publishedDate}
                                    onChange={(date) => setRecord({
                                        ...record,
                        ...
                        <div>
                            <Label htmlFor="seqNo">Sequence No.</Label> <span className="red-star"> *</span>
                            <div className="mt-1">
                                <TextInput
                        ...
                        <div>
                            <Label htmlFor="serialNo">Serial No.</Label> <span className="red-star"> *</span>
                            <div className="mt-1">
                                <TextInput
                                    id="serialNo"
                                    name="serialNo"
                        ...
                        <div>
                            <Label htmlFor="formNo">Form No.</Label> <span className="red-star"> *</span>
                            <div className="mt-1">
                                <TextInput
                                    id="formNo"
                                    name="formNo"
                    ...
                    >
                        <div className="mb-2 block">
                            <Label htmlFor="file" defaultValue="Upload file">Upload file</Label> <span className="red-star"> *</span>
                        </div>
                        <CustomFileInput file={file} setFile={setFile} fileName={record?.file?.name} />
                    </div>}
                </Modal.Body>
                <Modal.Footer className="justify-end">
                    <Button color="failure" onClick={() => { setOpen(false); setRecord(initRecord); }}>
                        Cancel
                    </Button>
                    <Button disabled={!isValid} color="success" onClick={() => handleSubmit()}>
                        Save
                    </Button>
                </Modal.Footer>
            </Modal>
